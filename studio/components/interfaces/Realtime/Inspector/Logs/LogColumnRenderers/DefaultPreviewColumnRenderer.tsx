...
import { LogData, PreviewLogData } from '../Logs.types'
import { RowLayout } from '../LogsFormatters'
import { isErrorLog } from '../LogTable'
...
const columnRenderer: Column<LogData, unknown>[] = [
  {
