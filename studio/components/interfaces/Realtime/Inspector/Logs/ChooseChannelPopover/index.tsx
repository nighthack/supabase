...
export const ChooseChannelPopover = ({ config, onSetConfig }: ChooseChannelPopoverProps) => {
        ...
        <div className="border-b border-overlay p-4 flex flex-col text-sm">
          ...
          <div className="flex flex-row">
            ...
            <Button
              ...
              onClick={() => onSetConfig({ ...config, channelName })}
            >
              Apply
            </Button>
          </div>
        ...
        <div className="border-b border-overlay p-4">
          <div className="flex items-center justify-between gap-2">
            ...
            <Toggle
              ...
              onChange={() => onSetConfig({ ...config, enablePresence: !config.enablePresence })}
            />
          </div>
        ...
        <div className="border-b border-overlay p-4">
          <div className="flex items-center justify-between">
            ...
            <Toggle
              ...
              onChange={() => onSetConfig({ ...config, enableBroadcast: !config.enableBroadcast })}
            />
          </div>
          <p className="text-xs  text-foreground-light pt-1">
        ...
        <div className="border-b border-overlay p-4">
          <div className="flex items-center justify-between">
            ...
            <Toggle
              ...
              onChange={() => onSetConfig({ ...config, enableDbChanges: !config.enableDbChanges })}
            />
          </div>
          <p className="text-xs text-foreground-light pt-1">
